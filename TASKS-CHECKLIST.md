...
- [x] 파일 감시
  - [x] chokidar 의존성 추가
  - [x] `.sdd/specs/` 디렉토리 감시
  - [x] 파일 생성/수정/삭제 이벤트 감지
  - [x] 디바운싱 구현
- [x] 자동 검증
  - [x] 변경 시 validate 자동 실행
  - [x] 결과 실시간 표시
  - [x] 에러/경고 카운트 요약
- [x] CLI 통합
  - [x] `sdd watch` 명령어 추가
  - [x] `--validate`, `--impact`, `--quiet` 옵션
- [x] 테스트 작성
...
- [x] 개선 제안
  ...
  - [x] 우선순위 표시
- [x] CLI 통합
  - [x] `sdd quality [feature]` 명령어
  - [x] `sdd quality --all` 전체 분석
- [x] 테스트 작성
...
- [x] 자동 변환
  ...
  - [x] frontmatter 자동 추가
- [x] CLI 통합
  - [x] `sdd migrate detect` 명령어
  - [x] `sdd migrate openspec` 명령어
  - [x] `sdd migrate speckit` 명령어
- [x] 테스트 작성
...
| 5.2 | 품질 점수 산출 | ✅ 완료 |
| 5.2 | 개선 제안 | ✅ 완료 |
| 5.2 | CLI 통합 (quality) | ✅ 완료 |
| 5.2 | 테스트 | ✅ 완료 |
| 5.3 | 리포트 생성 | ✅ 완료 |
| 5.3 | 리포트 내용 | ✅ 완료 |
| 5.3 | CLI 통합 (report) | ✅ 완료 |
| 5.3 | 테스트 | ✅ 완료 |
| 5.4 | 프로젝트 감지 | ✅ 완료 |
| 5.4 | 자동 변환 | ✅ 완료 |
| 5.4 | CLI 통합 (migrate) | ✅ 완료 |
| 5.4 | 테스트 | ✅ 완료 |
